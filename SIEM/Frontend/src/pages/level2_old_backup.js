...
// === PHASE 1: ALERT TRIAGE (18 Static Questions) ===
function buildGeneralQuestions() {
  // Build static questions that don't depend on dynamic alert IDs
  const questions = [];

  // Q1-Q12: Static Scenario-Based Questions
  const staticScenarios = [
    { id: 'q1', title: 'Developer cloned 4.8GB repository (sarah.mitchell) - outside normal workflow', answer: 'true_positive', hint: 'Extremely large size + Outside workflow = HIGH severity' },
    { id: 'q2', title: 'Developer accessed HR employee database (role violation)', answer: 'true_positive', hint: 'Clear role violation = HIGH severity' },
    { id: 'q3', title: 'Massive file read: 4,823 files, 2.1GB in bulk', answer: 'true_positive', hint: 'Bulk data collection pattern = HIGH severity' },
    { id: 'q4', title: 'ZIP archive created: 1.9GB of collected data', answer: 'true_positive', hint: 'Preparation for exfiltration = CRITICAL' },
    { id: 'q5', title: 'Google Drive upload: 1.9GB to personal account (not corporate)', answer: 'true_positive', hint: 'Personal cloud + Large data = CRITICAL exfiltration' },
    { id: 'q6', title: 'DLP blocked cloud upload - sensitive data patterns detected', answer: 'true_positive', hint: 'Attempted exfiltration = HIGH severity' },
    { id: 'q7', title: 'DevOps CI/CD backup: 3.2GB Git mirror (SVC_DevOps, scheduled)', answer: 'false_positive', hint: 'Service account + Scheduled backup = Benign' },
    { id: 'q8', title: 'HR payroll export: 482MB (jennifer.adams, HR team)', answer: 'false_positive', hint: 'Legitimate job function = Benign' },
    { id: 'q9', title: 'Corporate OneDrive sync: 1.8GB (business hours)', answer: 'false_positive', hint: 'Corporate account + Standard sync = Benign' },
    { id: 'q10', title: 'IT support USB usage (ticket INC-2024-0145)', answer: 'false_positive', hint: 'IT role + Ticket number = Benign' },
    { id: 'q11', title: 'Database backup: 2.4GB (SVC_SQLBackup, 02:00 scheduled)', answer: 'false_positive', hint: 'Service account + Overnight backup = Benign' },
    { id: 'q12', title: 'Developer overtime VPN: 20:45 (ticket CHG-2024-0089, deployment)', answer: 'false_positive', hint: 'Approved ticket + Production deployment = Benign' }
  ];
